...
void cache_rest() { return syscall0(SYS_CACHE_RESET); }
int cache_num_hits() { return syscall0(SYS_GET_HITS); }
unsigned long long get_write_count() { return syscall0(SYS_WRITE_COUNT); }
